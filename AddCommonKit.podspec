#
#  Be sure to run `pod spec lint AddCommonKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: spec.author    = "HFK"
  # spec.authors            = { "HFK" => "416567352@qq.com" }
  # spec.social_media_url   = "https://twitter.com/HFK"
