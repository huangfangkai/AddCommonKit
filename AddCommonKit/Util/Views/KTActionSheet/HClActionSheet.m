...
-(void)initUIData{
    self.itemTextColor = [UIColor colorWithHexString:@"1d1d26"];
    self.itemTextFont = [UIFont systemFontOfSize:15];
    self.cancleTextColor = [UIColor colorWithHexString:@"1d1d26"];
    self.cancleTextFont = [UIFont systemFontOfSize:15];
    self.cancleTitle = @"取消";
}
